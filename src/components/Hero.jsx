...
const Hero = () => {
  return (
    <div className='relative'>
      ...
      <div className="pb-10 pt-6 cards mx-auto sm:px-5 lg:px-0">
        <div className="flex flex-wrap justify-center items-center gap-20">
        <div className="min-w-[265px] min-h-[200px] w-1/6 flex items-center justify-center rounded bg-base-200 md:pt-0 card">
          ...
          <div className="min-w-[265px] min-h-[200px] w-1/6 flex items-center justify-center bg-base-200 rounded md:pt-0 card">
